...
//  ARrrr
//
//  Created by Timothy Poulsen on 5/17/19.
...
class TabDepthCamVC: UIViewController {
...
//extension TabDepthCamVC: AVCaptureVideoDataOutputSampleBufferDelegate {
//
...
extension TabDepthCamVC: AVCapturePhotoCaptureDelegate {
